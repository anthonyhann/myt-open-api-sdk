 ...
 * @since 1.0.0
 */
public class OrderApplyRefundGoodsInfo {
    ...
    public OrderApplyRefundGoodsInfo() {
    }
    ...
    public boolean equals(Object o) {
        ...
        OrderApplyRefundGoodsInfo that = (OrderApplyRefundGoodsInfo) o;
    ...
    public String toString() {
        return "OrderApplyRefundGoodsInfo{" +
                "goodsId='" + goodsId + '\'' +
                ", goodsName='" + goodsName + '\'' +
                ", skuId='" + skuId + '\'' +
                ", upc='" + upc + '\'' +
