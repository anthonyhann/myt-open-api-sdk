// Package client 提供麦芽田开放平台 Go SDK 的 HTTP 客户端实现
// 包含企业级特性：连接池管理、自动重试、签名生成、日志记录等
package client
...
// SDKVersion SDK 版本号
// 从 vars.VERSION 获取，该值来自 version.txt 文件，并去除换行符
